...
import { Texture, resources, Shader, Program, Geometry, Buffer, ObjectRenderer, BaseTexture, Renderer } from '@pixi/core';
...
class RectTileLayer extends Container {
    ...
    renderWebGLCore(renderer, plugin) {
        ...
        if (this.modificationMarker !== vertices) {
            ...
            let arr = this.vbArray; this.vbInts;
            //upload vertices!
            let sz = 0;
            //let tint = 0xffffffff;
            let textureId = 0;
...
class CompositeRectTileLayer extends Container {
    constructor(zIndex, bitmaps, texPerChild) {
        super();CompositeRectTileLayer.prototype.__init.call(this);CompositeRectTileLayer.prototype.__init2.call(this);CompositeRectTileLayer.prototype.__init3.call(this);CompositeRectTileLayer.prototype.__init4.call(this);CompositeRectTileLayer.prototype.__init5.call(this);        this.initialize.apply(this, arguments);
    }
...
class TilemapShader extends Shader {
	...
	constructor(maxTextures, shaderVert, shaderFrag) {
		...
		);TilemapShader.prototype.__init.call(this);		this.maxTextures = maxTextures;
...
class RectTileGeom extends Geometry {
	...
	constructor() {
		super();RectTileGeom.prototype.__init2.call(this);RectTileGeom.prototype.__init3.call(this);RectTileGeom.prototype.__init4.call(this);RectTileGeom.prototype.__init5.call(this);		const buf = this.buf = new Buffer(new Float32Array(2), true, false);
...
class TileRenderer extends ObjectRenderer {
	...
	constructor(renderer) {
		super(renderer);TileRenderer.prototype.__init.call(this);TileRenderer.prototype.__init2.call(this);TileRenderer.prototype.__init3.call(this);TileRenderer.prototype.__init4.call(this);TileRenderer.prototype.__init5.call(this);TileRenderer.prototype.__init6.call(this);		this.rectShader = new RectTileShader(Constant.maxTextures);
...
class ZLayer extends Container {
    ...
    constructor(tilemap, zIndex) {
        super();ZLayer.prototype.__init.call(this);        this.tilemap = tilemap;
        this.z = zIndex;
    }
